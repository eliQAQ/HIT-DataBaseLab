            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">查询学生选课退课，老师对成绩的更改，老师对课程的更改</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        $q = "select id, operation, operation_time,operation_params from curricula_insert_log;";
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        //选择数据库
                                        $db = mysqli_select_db($conn, "university");
                                        $q = "select id, operation, operation_time,operation_params from curricula_result_log;";
                        ...
                        <div class="col-xs-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-title">
                                    <div class="title">老师修改课程信息日志</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                                    <?php
                                        ...
                                        //选择数据库
                                        $db = mysqli_select_db($conn, "university");
                                        $q = "select id, operation, operation_time,operation_params from course_log;";
