                            ...
                            <li class="active panel panel-default dropdown">
                                ...
                                <div id="dropdown-table" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            <li><a href="../table/table.php">当前已选课表</a>
                                            </li>
            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">显示当前可选课程并进行选课</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <?php
                                            ...
                                            $q = "select Tname, Course.Cno, Cname, Croom, Ctime from Course,TCourse,Teacher where Course.Cno = TCourse.Cno and Teacher.Tno=TCourse.Tno and Course.Cno not in (select Cno from Curricula where Sno = '$Sno');";
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        <input type="text" name="chosenCourse" class="form-control" placeholder="输入选择课程号">
                                    </div>   
