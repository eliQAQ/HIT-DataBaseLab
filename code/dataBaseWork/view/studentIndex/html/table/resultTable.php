            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">显示当前已选课程获得成绩课程</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        $q = "select Cname,result from Course,Curricula where Course.Cno=Curricula.Cno and Curricula.Sno = '$Sno';";
                                        ...
                                        $q = "select Sno, avg(result) from Curricula group by Sno having Sno='$Sno';";
                                        $result = mysqli_query($conn, $q);
                                        while ($row=mysqli_fetch_row($result)){
                                            echo "<h1>您当前的平均分为:".$row[1]."</h1>";
                                        }
                                    ?>
