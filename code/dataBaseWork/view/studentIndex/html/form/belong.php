                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <?php
                                            ...
                                            $q = "select Tname, Class.Cno, Class.Croom, Iname, Dname from Teacher, IStudent,Class,CStudent,Department,Institute where Teacher.Tno = Class.Tno and CStudent.Sno='$Sno' and Class.Cno = CStudent.Cno and Institute.Ino=IStudent.Ino and IStudent.Sno='$Sno' and Institute.Dno = Department.Dno;";
