            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">显示当前学生的非隐私信息</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        $q = "select v_student.Sno,  Sname, Cno,Sage, Sgrade,Iname from CStudent,v_student,IStudent,Institute where v_student.Sno=CStudent.Sno and v_student.Sno=IStudent.Sno and Institute.Ino = IStudent.Ino;";
