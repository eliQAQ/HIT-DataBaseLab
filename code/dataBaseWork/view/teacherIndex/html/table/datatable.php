                        ...
                        <li class="dropdown profile">
                            ...
                            <ul class="dropdown-menu animated fadeInDown">
                                ...
                                <?php
                                    ...
                                    $q = "select Tname,Tage,Tmail, Tphone from Teacher where Tno = '$Tno';";
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active panel panel-default dropdown">
                                <a data-toggle="collapse" href="#dropdown-table">
                                    <span class="icon fa fa-table"></span><span class="title">开设课程表</span>
                                </a>
                                <!-- Dropdown level 1 -->
                                <div id="dropdown-table" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            <li><a href="../table/table.php">当前开设课程</a>
                                            </li>
                                            <li><a href="../table/datatable.php">学生课程成绩表</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">学生课程成绩表</span>
                        <div class="description">显示学生的课程成绩</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        $q = "select Curricula.Sno, Curricula.Cno, Sname,Cname,result from  Curricula, Student,Course where Curricula.Cno = Course.Cno and Student.Sno = Curricula.Sno and Curricula.Cno in (select Cno from TCourse where Tno = '$Tno');";
                                        ...
                                        while ($row=mysqli_fetch_row($result)){
                                            ...
                                            <td>$row[0]</td>
                                            <td>$row[2]</td>
                                            <td name='Cno'>$row[3]</td>
                                            <td><input name='$name' placeholder='$row[4]'></td>
                                            </tr>";
                                        }
                                        echo '</tbody>';
                                    ?>
                                    ...
                                    <button type="submit" class="btn btn-default">提交成绩修改</button> 
                                    </form>
                                </div>
                            </div>
                        </div>
