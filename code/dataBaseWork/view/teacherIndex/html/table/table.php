                ...
                <div class="container-fluid">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown profile">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">个人主页 <span class="caret"></span></a>
                            <ul class="dropdown-menu animated fadeInDown">
                                ...
                                <div id="dropdown-table" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li><a href="../table/datatable.php">学生课程成绩</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">当前开设课程</span>
                        <div class="description">显示您当前所开设课程</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        $q = "select Course.Cno,  Cname, Croom, Ctime from Course,TCourse Where TCourse.Cno = Course.Cno and TCourse.Tno = '$Tno' ;";
                                        ...
                                        while ($row=mysqli_fetch_row($result)){
                                            ...
                                            <td>$row[0]</td>
                                            <td>$row[1]</td>
                                            <td><input name='$name1' placeholder='$row[2]'></td>
                                            <td><input name='$name2' placeholder='$row[3]'></td>
                                            </tr>";
                                        }
                                        echo '</tbody>';
                                    ?>  
