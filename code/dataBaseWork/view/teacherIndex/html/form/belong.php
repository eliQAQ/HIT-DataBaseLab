            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">所属关系</span>
                        <div class="description">显示当前所属关系</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <?php
                                            ...
                                            $q = "select Lab.Lno, Lname, Position, Laddress, Institute.Ino, Iname, Department.Dno, Dname from Lab,LTeacher,Institute,Department where LTeacher.Tno='$Tno' and LTeacher.Lno=Lab.Lno and Institute.Ino=Lab.Ino and Department.Dno=Institute.Dno;";
